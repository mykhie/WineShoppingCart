 ...
 */
!function (a, b) {
    var c = b.isDefined, d = b.isUndefined, e = b.isNumber, f = b.isObject, g = b.isArray, h = b.isString, i = b.extend,
        j = b.toJson;
        ...
        this.prefix = "ls", this.storageType = "localStorage", this.cookie = {
            ...
            var u = function (a) {
                ...
                try {
                    ...
                    var d, e;
                    for (d = 0; d < arguments.length - c; d++) if (e = arguments[d], !y && p.defaultToCookie || "cookie" === p.storageType) y || a.$broadcast("LocalStorageModule.notification.warning", "LOCAL_STORAGE_NOT_SUPPORTED"), s.removeItem && a.$broadcast("LocalStorageModule.notification.removeitem", {
                        key: e,
                        storageType: "cookie"
                    }), H(e); else try {
                ...
                try {
                    ...
                    var d = q.length, e = [];
                    for (var f in o) if (f.substr(0, d) === q) try {
                        e.push(f.substr(d))
                    } catch (b) {
                ...
                try {
                    K(c);
                    var e = q ? new RegExp("^" + q) : new RegExp, f = b ? new RegExp(b) : new RegExp;
                    ...
                    var g = q.length;
                    for (var h in o) if (e.test(h) && f.test(h.substr(g))) try {
                        B(h.substr(g))
                    } catch (b) {
            ...
            return {
                ...
                cookie: {isSupported: E, set: F, add: F, get: G, remove: H, clearAll: I}
            }
        }]
    })
