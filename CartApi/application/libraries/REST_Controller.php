 ...
 * A fully RESTful server implementation for CodeIgniter using one libraries, one config file and one controller.
 *
 * @package         CodeIgniter
...
abstract class REST_Controller extends CI_Controller {
    ...
    public function __construct($config = 'rest')
    {
        ...
        // At present the libraries is bundled with REST_Controller 2.5+, but will eventually be part of CodeIgniter (no citation)
    ...
    /**
     * Perform Library Authentication - Override this function to change the way the libraries is called
     *
     * @access protected
     * @param  string $username The username to validate
     * @param  string $password The password to validate
    ...
    protected function _prepare_digest_auth()
    {
        ...
        // For digest authentication the libraries function should return already stored md5(username:restrealm:password) for that username @see rest.php::auth_library_function config
